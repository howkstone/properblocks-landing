...
There is a six-month service guarantee. Where Proper Blocks fails materially or persistently to manage a building to the standard set out in its management agreement, the client can end the agreement inside the first six months and every management fee and the onboarding fee is returned. The client's board decides whether the standard was met, giving its reasons in writing, and no proof of loss is required; where Proper Blocks disagrees with that decision an independent chartered surveyor settles it and the cost is shared. A change of mind is not covered. The wording is clause 9.5 of the management agreement.
